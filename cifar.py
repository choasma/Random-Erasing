...
def main():
    ...
    trainset = dataloader(root='assets/data/cifar10-data', train=True, download=True, transform=transform_train)
    trainloader = data.DataLoader(trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers)

    testset = dataloader(root='assets/data/cifar10-data', train=False, download=False, transform=transform_test)
